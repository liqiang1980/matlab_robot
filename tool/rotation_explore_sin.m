...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function T_robot_end_eff_cur = rotation_explore_sin(T_robot_end_eff_init,ind)
scale = 0.5;
if((mod(ind,200)<50)&&(mod(ind,200)>=0))
rotate_actx = r2t(rotx(sin(pi/100*mod(ind,200))*scale));
rotate_acty = eye(4);
rotate_actz = eye(4);
end
...
rotate_actx = eye(4);
rotate_acty = r2t(roty(sin(pi/100*(mod(ind,200)-100))*scale));
rotate_actz = eye(4);
end
