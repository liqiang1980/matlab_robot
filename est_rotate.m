% Estimate the rotation angle of tool frame tagent surface using the real
% normal direciton.
%
% rotate_angle = est_rotate() is function to update
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function rotate_angle = est_rotate(virtual_angle)
